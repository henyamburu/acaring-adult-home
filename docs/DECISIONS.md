...
| 2026-06-09 | Do not add `geo`, `sameAs`, `aggregateRating`, reviews, or a medical schema subtype | Coordinates, official social/profile URLs, displayed compliant reviews, and medical-clinic representation have not been verified | Active |
...
| Separate Google Business Profiles | One profile, two profiles, none verified | Not verified; no `sameAs` links added |
